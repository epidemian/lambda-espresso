...
(function() {
  var Abstraction, Application, Lambda, Term, Variable, parser,
  ...
  Variable = (function(_super) {
    ...
    Variable.prototype.reduce = function() {
      return this;
    };

    Variable.prototype.apply = function() {
      return false;
    };
  ...
  Abstraction = (function(_super) {
    ...
    Abstraction.prototype.reduce = function() {
      return new Abstraction(this.varName, this.body.reduce());
    };

    Abstraction.prototype.apply = function(term) {
  ...
  Application = (function(_super) {
    ...
    Application.prototype.reduce = function() {
      var leftReduced, rightReduced;
      leftReduced = this.left.reduce();
      rightReduced = this.right.reduce();
      return (leftReduced.apply(rightReduced)) || new Application(leftReduced, rightReduced);
    };

    Application.prototype.apply = function() {
      return false;
    };
  ...
  Lambda = typeof exports !== "undefined" && exports !== null ? exports : (this.Lambda = {});

  Lambda.parse = function(expr) {
    return (parser.parse(expr)).toString();
  };

  Lambda.reduce = function(expr) {
    return (parser.parse(expr)).reduce().toString();
  };
