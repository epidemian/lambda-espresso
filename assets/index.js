...
// Generated by CoffeeScript 1.7.1
(function() {
  var $error, $errorContainer, $examplesMenu, $input, $output, $outputContainer, example, examples, getOptions, hash, i, lambda, preserveScrollPosition, renderArrow, renderArrowByType, renderCollapsedReduction, renderCollapsedReductionForm, renderExpandedReductionForm, renderReductions, renderStepOptions, renderSynonyms, renderTerm, run, timed, updateInputFromHash, _i, _len;
