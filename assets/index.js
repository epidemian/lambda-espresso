...
require['./lambda'] = new function() {
  ...
  // Generated by CoffeeScript 1.3.3
(function() {
  var Abstraction, Application, Macro, Variable, applyStep, isFree, logTerm, parse, parseTerm, reduceStep, reduceTerm, renameAbstractionVar, repeatStr, substitute, termStr, type, varRenameCollides;

  repeatStr = require('./helpers').repeatStr;
    ...
    switch (type(t)) {
      ...
      case Abstraction:
        ...
        if ((isFree(t.varName, s)) && (isFree(x, t.body))) {
          return substitute(renameAbstractionVar(t, s), x, s);
        } else {
  ...
  renameAbstractionVar = function(abstraction, substitutionTerm) {
    ...
    while (!(newName && isValid)) {
      newName = base + ++n;
      isValid = !(isFree(newName, substitutionTerm)) && !(isFree(newName, body)) && !(varRenameCollides(body, varName, newName));
    }
