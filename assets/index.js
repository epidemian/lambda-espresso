...
require['./index'] = new function() {
  ...
  // Generated by CoffeeScript 1.3.3
(function() {
  var $error, $errorContainer, $examplesMenu, $input, $output, $outputContainer, examples, lambda, options, preserveScroll, run, updateInputFromHash, updateOutputExpansions;
  ...
  run = function() {
    ...
    try {
      ...
      ($('.reduction', $output)).click(function() {
        var _this = this;
        return preserveScroll(function() {
