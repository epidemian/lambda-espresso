...
// Generated by CoffeeScript 1.6.3
(function() {
  var $error, $errorContainer, $examplesMenu, $input, $output, $outputContainer, arrowHtml, arrowHtmlByType, arrowLabel, arrowSymbol, examples, getOptions, lambda, options, preserveScrollPosition, run, termHtml, updateInputFromHash, updateOutputExpansions;
  ...
  run = function() {
    var after, before, collapsed, e, final, initial, program, reductions, result, steps, type, _i, _j, _len, _len1, _ref, _ref1;
    program = $input.val();
    try {
...
},{"./examples":1,"./lambda":5}],5:[function(require,module,exports){
// Generated by CoffeeScript 1.6.3
(function() {
  var Abstraction, AlphaConversionStep, Application, BetaReductionStep, Macro, MacroExpansionStep, Step, Variable, applyStep, compose, defaultOptions, extend, freeIn, highlight, highlightAbstractionVar, highlightStepMatch, highlightSubstitutionTerm, highlightSubstitutionVariable, logTerm, parse, parseTerm, reduceStep, reduceTerm, renameStep, renameVar, repeatStr, substitute, termStr, varRenameCollides, wrapStep, _ref;

  _ref = require('./helpers'), repeatStr = _ref.repeatStr, extend = _ref.extend, compose = _ref.compose;
  ...
  reduceTerm = function(term, options) {
