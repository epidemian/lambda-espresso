...
require['./lambda'] = new function() {
  ...
  // Generated by CoffeeScript 1.3.3
(function() {
  var Abstraction, Application, Macro, Variable, applyStep, isFree, leftApplicationStr, logTerm, parse, parseTerm, reduceStep, reduceTerm, renameVar, rightApplicationStr, substitute, termStr, type, varRenameCollides;
  ...
  logTerm = function(t, ind) {
    ...
    log = function(msg) {
      ...
      return console.log(((function() {
        var _i, _results;
        _results = [];
        for (i = _i = 0; 0 <= ind ? _i < ind : _i > ind; i = 0 <= ind ? ++_i : --_i) {
          _results.push('| ');
        }
        return _results;
      })()).join('') + msg);
