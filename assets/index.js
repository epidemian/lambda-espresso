...
// Generated by CoffeeScript 1.6.3
(function() {
  var $error, $errorContainer, $examplesMenu, $input, $output, $outputContainer, arrowHtml, arrowHtmlByType, arrowLabel, arrowSymbol, example, examples, getOptions, hash, i, lambda, options, preserveScrollPosition, run, termHtml, updateInputFromHash, updateOutputExpansions, _i, _len;
