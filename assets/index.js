...
// Generated by CoffeeScript 1.6.3
(function() {
  var $error, $errorContainer, $examplesMenu, $input, $output, $outputContainer, arrowHtml, arrowHtmlByType, arrowLabel, arrowSymbol, example, examples, getOptions, hash, i, lambda, options, preserveScrollPosition, renderReductions, run, termHtml, timed, updateInputFromHash, updateOutputExpansions, _i, _len;
  ...
  renderReductions = timed('render html', function(reductions) {
    var collapsed, final, initial, result, steps, _i, _len, _ref;
    result = '';
    ...
    return ($('.expanded .step', $output)).hover(function() {
      var $step;
      $step = $(this);
...
// Generated by CoffeeScript 1.6.3
(function() {
  var Abstraction, AlphaConversionStep, Application, BetaReductionStep, Macro, MacroExpansionStep, Step, Variable, apply, applyStep, composeAbs, composeAppL, composeAppR, composeMacro, defaultOptions, extend, freeIn, highlight, highlightAbstractionVar, highlightStepMatch, highlightSubstitutionTerm, highlightSubstitutionVariable, logTerm, parse, parseTerm, reduceCallByName, reduceNormal, reduceStep, reduceTerm, renameStep, renameVar, repeatStr, substitute, substitute2, termStr, timed, varRenameCollides, wrapStep, _ref;

  _ref = require('./helpers'), repeatStr = _ref.repeatStr, extend = _ref.extend, timed = _ref.timed;
  ...
  highlightAbstractionVar = function(t, x, fn) {
    var ht, hx;
    if (fn == null) {
      fn = highlightSubstitutionVariable;
    }
  ...
  reduceNormal = function(t, cb) {
    ...
    switch (t.type) {
      ...
      case Macro:
        cb(t.term);
        return reduceNormal(t.term, composeMacro(cb, t.name));
    }
  };
  ...
  reduceCallByName = function(t, cb) {
    ...
    switch (t.type) {
      ...
      case Macro:
        cb(t.term);
        return reduceCallByName(t.term, composeMacro(cb, t.name));
    }
  };
  ...
  reduceTerm = timed('reduce', function(term, options) {
    var e, enough, final, initial, maxSteps, steps, terminates;
  ...
  exports.logTerm = function(str) {
    return logTerm(parseTerm(str));
  };
