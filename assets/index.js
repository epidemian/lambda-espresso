...
// Generated by CoffeeScript 1.7.1
(function() {
  var $error, $errorContainer, $examplesMenu, $input, $output, $outputContainer, example, examples, getOptions, hash, i, lambda, renderArrow, renderArrowByType, renderCollapsedReduction, renderCollapsedReductionForm, renderExpandedReductionForm, renderReductions, renderStepOptions, renderSynonyms, renderTerm, run, timed, updateInputFromHash, _i, _len;
  ...
  renderExpandedReductionForm = function(reduction) {
    ...
    steps = (function() {
      ...
      _results = [];
      for (i = _i = 0, _ref = reduction.totalSteps; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
        ...
        _results.push("<span class=step>" + before + "<br>" + arrow + " " + after + " " + synonyms + "</span>");
      }
      return _results;
    })();
...
// Generated by CoffeeScript 1.7.1
(function() {
  var Abstraction, Application, Macro, Variable, alphaEq, apply, applySubstitution, compose, composeAbs, composeAppL, composeAppR, defaultOptions, expandStep, extend, find, findSynonyms, freeIn, highlight, highlightAbstractionVar, identity, markStep, parse, parseTerm, reduceApplicative, reduceCallByName, reduceCallByValue, reduceFunctions, reduceNormal, reduceTerm, renameForSubstitution, renameVar, repeatStr, replace, substitute, termStr, termTreeStr, timed, varRenameCollides, _ref,
    __slice = [].slice;
  ...
  reduceTerm = timed('reduce', function(term, macros, options) {
    var e, enough, final, finalSynonyms, initial, maxSteps, reduce, renderStep, steps, strategy, terminates, totalSteps, _ref1;
    _ref1 = extend({}, defaultOptions, options), maxSteps = _ref1.maxSteps, strategy = _ref1.strategy;
