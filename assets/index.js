...
require['./lambda'] = new function() {
  ...
  // Generated by CoffeeScript 1.3.3
(function() {
  var Abstraction, Application, Macro, Variable, applyStep, freeIn, logTerm, parse, parseTerm, reduceStep, reduceTerm, renameStep, renameVar, repeatStr, substitute, termStr, varRenameCollides;
  ...
  reduceStep = function(t) {
    ...
    switch (t.type) {
      ...
      case Abstraction:
        ...
        return reducedBody && Abstraction(t.varName, reducedBody);
      case Application:
        ...
        return reducedRight && Application(t.left, reducedRight);
      case Macro:
  ...
  applyStep = function(t, s) {
    ...
    switch (t.type) {
      ...
      case Abstraction:
        ...
        return substitute(body, varName, s);
      case Macro:
        return (applyStep(t.term, s)) && Application(t.term, s);
    }
  };

  renameStep = function(t, x, s) {
    var newVarName, renamedBody, renamedLeft, renamedRight;
    switch (t.type) {
      case Variable:
      case Macro:
        return null;
      case Abstraction:
        ...
        if ((freeIn(t.varName, s)) && (freeIn(x, t.body))) {
          ...
          return Abstraction(newVarName, substitute(t.body, t.varName, Variable(newVarName)));
        } else {
          renamedBody = renameStep(t.body, x, s);
          return renamedBody && Abstraction(t.varName, renamedBody);
        }
        break;
      case Application:
