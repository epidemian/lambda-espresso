...
require['./lambda'] = new function() {
  ...
  // Generated by CoffeeScript 1.3.3
(function() {
  var Abstraction, Application, Macro, Step, Variable, applyStep, freeIn, logTerm, parse, parseTerm, reduceStep, reduceTerm, renameStep, renameVar, repeatStr, substitute, termStr, varRenameCollides, wrapStep;
  ...
  Step = function(type, before, after) {
    return {
      type: type,
      before: before,
      after: after,
  ...
  applyStep = function(t, s) {
    ...
    switch (t.type) {
      ...
      case Abstraction:
        ...
        return Step('beta', Application(t, s), substitute(body, varName, s));
      case Macro:
...
require['./index'] = new function() {
  ...
  // Generated by CoffeeScript 1.3.3
(function() {
  var $error, $errorContainer, $examplesMenu, $input, $output, $outputContainer, arrowHtml, arrowHtmlByType, arrowLabel, arrowSymbol, examples, lambda, options, preserveScrollPosition, run, stepHtml, updateInputFromHash, updateOutputExpansions;
  ...
  run = function() {
    var collapsed, final, i, initial, program, reductions, result, step, steps, _i, _j, _len, _len1, _ref;
    program = $input.val();
    try {
      ...
      for (_i = 0, _len = reductions.length; _i < _len; _i++) {
        ...
        collapsed = !steps.length ? stepHtml(initial) : (stepHtml(initial)) + ' ' + (arrowHtml('→', "(" + steps.length + ")")) + ' ' + (stepHtml(final));
